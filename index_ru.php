...
<!-- End Google Tag Manager -->
    ...
    <meta name="description" content="Самая низкая цена на красную и черную ИКРУ в Украине!" />
    <meta property="og:url" content="/" />
    <meta property="og:title" content=Ikra-shopping - Магазин" />
    <meta property="og:description" content="Самая низкая цена на красную и черную ИКРУ в Украине!" />
                ...
                <div class="t228__maincontainer " style="height:100px;">
                    ...
                    <div class="t228__leftside">
                        <div class="t228__leftcontainer">
                            <div style="color:#ffffff; "><img src="img/233.png" class="t228__imglogo " alt=" IIkra-shopping "></div>
                        </div>
                    </div>
                            ...
                            <div class="t-cover__wrapper t-valign_middle" style="height:100vh;">
                                <div class="t415__content" data-hook-content="covercontent">
                                    <div class="t415__textwrapper t-width t-width_12">
                                        <div class="t415__title t-title t-title_md" field="title" style="color:#ffffff; "><br>ИКРА <span style="color: rgb(255, 68, 0);">КРАСНАЯ</span> И <span style="color:#ffffff;">ЧЕРНАЯ</span><br></span>СКИДКИ ДО -50% !
                                            <br>
                                        </div>
                                        <div class="t415__descr t-descr t-descr_md" field="descr" style="color:#ffffff; ">
                                        	<div><h2 ><strong style="color:#ffffff;">АКЦИЯ  1+1=3</strong></h2></div>
                                            <div style="font-size:30px;color:#ffffff;" data-customstyle="yes"><strong></strong><strong>При покупке 2-х баночек 500г икры,<br> </strong><strong>баночка 500г в подарок!</strong><span style="color: rgb(255, 24, 0);"><strong></strong></span></div>
                                        </div>
                                    </div>
                                    <div id="t415__timer158760520" class="t415__timer">
                                    	<div><h2 style="color:#ffffff; " >До конца Акции осталось:</h2></div>
                                        <div class="t415__col t415__hide"> <span class="t415__days t-title t-title_lg t415__number" style="color: #ffffff"></span>
                                                <div class="t415__text t-descr t-descr_xxs" style="color: #ffffff">Дней</div>
                                        </div>
                                        <div class="t415__col"> <span class="t415__hours t-title t-title_lg t415__number" style="color: #ffffff"></span>
                                            <div class="t415__text t-descr t-descr_xxs" style="color: #ffffff">Часов</div>
                                        </div>
                                        <div class="t415__col"> <span class="t415__minutes t-title t-title_lg t415__number" style="color: #ffffff"></span>
                                            <div class="t415__text t-descr t-descr_xxs" style="color: #ffffff">Минут</div>
                                        </div>
            ...
            <div class="t702">
                <div class="t-popup" data-tooltip-hook="#popup:myform2">
                    ...
                    <div class="t-popup__container t-width t-width_6"> <img class="t702__img t-img" src="img/__27.png" data-original="img/__27.png" imgfield="img">
                        <div class="t702__wrapper">
                            <div class="t702__text-wrapper t-align_center">
                                <div class="t702__title t-title t-title_xxs" style="">Акция "1+1=3"
                                    <br>
                                </div>
                            </div>
                            <form id="form3" action='order.php' method='POST' class="t-form t-form_inputs-total_2 form-area">
                                ...
                                <select name="Quantity" class="quantity" style="height: 60px;background-color: transparent;border-radius: 5px;width: 91%;border: 1px solid #c9c9c9;padding: 0 20px;font-size: 16px;color: #000">
                                    <option value="Горбуша 2 по 0.5 = 1080 грн." selected>Горбуша: 2 по 0.5 = 1080 грн. + 0.5 в подарок!</option>
                                    <option value="Кета 2 по 0.5 = 1160 грн. + 0.5 в подарок!">Кета: 2 по 0.5 = 1160 грн. + 0.5 в подарок!</option>
                                    <option value="Веслонос 2 по 0.5 = 1800 грн. + 0.5 в подарок!">Веслонос: 2 по 0.5 = 1800 грн. + 0.5 в подарок!</option>
                                     <option value="Щука 2 по 0.5 = 1000 грн. + 0.5 в подарок!">Щука: 2 по 0.5 = 1000 грн. + 0.5 в подарок!</option>
                                      <option value="Форель 2 по 0.5 = 1220 грн. + 0.5 в подарок!">Форель: 2 по 0.5 = 1220 грн. + 0.5 в подарок!</option>
                                       <option value="Чавыча 2 по 0.5 = 1200 грн. + 0.5 в подарок!">Чавыча: 2 по 0.5 = 1200 грн. + 0.5 в подарок!</option>
                                        <option value="Осетр 2 по 0.5 = 1850 грн. + 0.5 в подарок!">Осетр: 2 по 0.5 = 1850 грн. + 0.5 в подарок!</option>
                                </select>
                                <input type="hidden" name="comm" value="Акция 1+1=3в">
                ...
                <div class="t-section__container t-container">
                    <div class="t-col t-col_12">
                        <div class="t-section__topwrapper t-align_center">
                            <div class="t-section__title t-title t-title_xs text" field="btitle">ПОЧЕМУ ВЫБИРАЮТ НАС</div>
                        </div>
                    </div>
                </div>
                <div class="t-container">
...
<g>
    ...
    <path d="M35.855,43.435H16.782c-0.829,0-1.5,0.671-1.5,1.5s0.671,1.5,1.5,1.5h19.073c0.829,0,1.5-0.671,1.5-1.5
		S36.684,43.435,35.855,43.435z"/>
                                ...
                                <div class="t491__title t-name t-name_sm text" style="" field="li_title__1476976310929">ТОЛЬКО СЕРТИФИЦИРОВАННАЯ ПРОДУКЦИЯ</div>
                            </div>
                            <div class="t491__descr t-descr t-descr_xs text" style="" field="li_descr__1476976310929">Мы работаем на прямую с крупнейшим поставщиком Икры в Украине с 2015 года. Они, а теперь и мы, заслужили свое доверие клиентов высочайшими стандартами и высочайшим качеством продукции.</div>
                        </div>
                    </div>
                    <div class="t491__col t-col t-col_4 t-item">
                        <div class="t491__content">
                            <div class="t491__wrapper">
                                ...
                                <div class="t491__title t-name t-name_sm text" style="" field="li_title__1476976315081">ОПЛАТА ПОСЛЕ ПРОВЕРКИ КАЧЕСТВА
                                    <br>
                                </div>
                            </div>
                            <div class="t491__descr t-descr t-descr_xs text" style="" field="li_descr__1476976315081">Мы работаем без всякой предоплаты. Вы оплачиваете товар только после того, как возьмете его в руки и полностью убедитесь в его качестве. Проверить качество вы можете получить товар курьером или на отделении Новой почты.</div>
                        </div>
                    </div>
                    <div class="t491__col t-col t-col_4 t-item">
                        <div class="t491__content">
                            <div class="t491__wrapper">
                                ...
                                <div class="t491__title t-name t-name_sm text" style="" field="li_title__1476976334035">БЫСТРАЯ ДОСТАВКА НОВОЙ ПОЧТОЙ</div>
                            </div>
                            <div class="t491__descr t-descr t-descr_xs text" style="" field="li_descr__1476976334035">Мы можем гарантировать самую быструю доставку по всей Украине благодаря тому, что наша компания является официальным партнером Новой Почты. Наши заказы обрабатываются и доставляются в кратчайшие сроки.</div>
                        </div>
                    </div>
                </div>
            </div>
         ...
         <section id="offer" class="offer night-theme-background active-color">
            <div class="offer-wrapper">
                <div class="item js-product">
                    ...
                    <div class="text-area">
                        <div class="item-title">ИКРА КЕТЫ<br></div>
                        <ul class="text-wrapper">
                            <li class="item-check-text">
                                <span class="check-img">✔</span>
                                <span class="strong">Состав:</span>
                                Икра Кеты, соль (5% малосольная), растительное масло;
                            </li>
                            <li class="item-check-text">
                                <span class="check-img">✔</span>
                                <span class="strong">Нерест 2023 года</span>
                            </li>
                            <li class="item-check-text">
                                <span class="check-img">✔</span>
                                <span class="strong">Тара:</span>
                                стеклянная закатанная баночка;
                            </li>
                            <li class="item-check-text">
                                <span class="check-img">✔</span>
                                <span class="strong">Размер икринок:</span>
                                5 мм;
                            </li>
                            <li class="item-check-text">
                                <span class="check-img">✔</span>
                                <span class="strong">Цвет икры:</span>
                                темно-оранжевый;
                            </li>
                            <li class="item-check-text">
                                <span class="check-img">✔</span>
                                <span class="strong">Консистенция:</span>
                                Сухая (жидкость 5%);
                            </li>
                            <li class="item-check-text">
                                <span class="check-img">✔</span>
                                <span class="strong">Срок годности:</span>
                                3 мес. (в закрытом виде);
                            </li>
                            <li class="item-check-text">2 недели ( в открытом);</li>
                    ...
                    <div class="item-button">КУПИТЬ В ОДИН КЛИК</div>
                    <!--Start TIMER-->
                    <div class="timer-wrapper">
                        <div class="timer-title-wrapper">
                            ...
                            <p class="text" >При покупке 2-х баночек 500г икры,баночка 500г в подарок!</p>
                        </div>
                        ...
                        <div class="timer-button">КУПИТЬ КЕТУ ПО АКЦИИ</div>
                    </div>
                    <!--END TIMER-->
                                ...
                                <form id="form4" action="order.php" method="POST" class="t-form t-form_inputs-total_2 form-area">
                                    ...
                                    <select name="Quantity" class="quantity" style="height: 60px;background-color: transparent;border-radius: 5px;width: 91%;border: 1px solid #c9c9c9;padding: 0 20px;font-size: 16px;color: #000;">
                                        <option value="Кета 0.5 = 580." selected="">Кета 0.5 = 580 грн.</option>
                                         <option value="Кета 2 по 0.5 = 1160 грн." selected="">Кета 2 по 0.5 = 1160 грн. + 0.5 в подарок!</option>
                                        <option value="Кета 3 по 0.5 = 1740 грн. + 0.5 в подарок!">Кета 3 по 0.5 = 1740 грн. + 0.5 в подарок!</option>
                                        <option value="Кета 4 по 0.5 = 2320 грн. + 0.5 в подарок!">Кета 4 по 0.5 = 2320 грн. + 0.5 в подарок!</option>
                                       
                                    </select>
                                    <input type="hidden" name="comm" value="Кета в один клик">
                                     <input type="hidden" name="ip" value="31.128.76.48" />
                                     	<label>
					<input type="checkbox" checked="checked" required="">
					<span></span>
                        ...
                        <div class="t-popup__container t-width t-width_6 t-popup__container-static t-popup__container-animated"> <img class="t702__img t-img loaded" src="img/__27.png" data-original="img/__27.png" imgfield="img">
                            <div class="t702__wrapper">
                                ...
                                <form id="form3" action="order.php" method="POST" class="t-form t-form_inputs-total_2 form-area">
                                    ...
                                    <input type="hidden" name="comm" value="Акция Кета">
                                     <input type="hidden" name="ip" value="31.128.76.48" />
                                     	<label>
					<input type="checkbox" checked="checked" required="">
					<span></span>
                ...
                <div class="item js-product">
                    ...
                    <div class="text-area">
                        <div class="item-title">ИКРА ЩУКИ<br></div>
                        <ul class="text-wrapper">
                            <li class="item-check-text">
                                <span class="check-img">✔</span>
                                <span class="strong">Состав:</span>
                                Икра Щуки, соль (2% малосольная), растительное масло;
                            </li>
                            <li class="item-check-text">
                                <span class="check-img">✔</span>
                                <span class="strong">Нерест 2023 года</span>
                    ...
                    <div class="timer-wrapper">
                        ...
                        <div class="timer-button">КУПИТЬ ЩУКИ ПО АКЦИИ</div>
                    </div>
                    <!--END TIMER-->
                    <!--Start POPUPS-->
                    <div class="t-popup t-popup_show order-popup">
                        ...
                        <div class="t-popup__container t-width t-width_6 t-popup__container-static t-popup__container-animated"> <img class="t702__img t-img loaded" src="img/__27.png" data-original="img/__27.png" imgfield="img">
                            <div class="t702__wrapper">
                                <div class="t702__text-wrapper t-align_center">
                                    <div class="t702__title t-title t-title_xxs" style="">КУПИТЬ ИКРУ ЩУКИ
                                        <br>
                                    </div>
                                </div>
                                <form id="form5" action="order.php" method="POST" class="t-form t-forьm_inputs-total_2 form-area">
                                    ...
                                    <select name="Quantity" class="quantity" style="height: 60px;background-color: transparent;border-radius: 5px;width: 91%;border: 1px solid #c9c9c9;padding: 0 20px;font-size: 16px;color: #000;">
                                        <option value="Щука 0.5 = 500 грн" selected="">Щука 0.5 = 500 грн</option>
                                          <option value="Щука по 0.5 = 1000 грн. + 0.5 в подарок!">Щука 2 по 0.5 = 1000 грн. + 0.5 в подарок!</option>
                                        <option value="Щука по 0.5 = 1500 грн. + 0.5 в подарок!">Щука 3 по 0.5 = 1500 грн. + 0.5 в подарок!</option>
                                        <option value="Щука по 0.5 = 2000 грн. + 2 по 0.5 в подарок!">Щука 4 по 0.5 = 2000 грн. + 2 по 0.5 в подарок!</option>
                        ...
                        <div class="t-popup__container t-width t-width_6 t-popup__container-static t-popup__container-animated"> <img class="t702__img t-img loaded" src="img/__27.png" data-original="img/__27.png" imgfield="img">
                            <div class="t702__wrapper">
                                ...
                                <form id="form3" action="order.php" method="POST" class="t-form t-form_inputs-total_2 form-area">
                                    ...
                                    <select name="Quantity" class="quantity" style="height: 60px;background-color: transparent;border-radius: 5px;width: 91%;border: 1px solid #c9c9c9;padding: 0 20px;font-size: 16px;color: #000">
                                        <option value="Щука 2 по 0.5 = 1000 грн. + 0.5 в подарок!">Щука 2 по 0.5 = 1000 грн. + 0.5 в подарок!</option>
                                        <option value=">Щука 3 по 0.5 = 1500 грн. + 0.5 в подарок!">Щука 3 по 0.5 = 1500 грн. + 0.5 в подарок!</option>
                                        <option value="Щука 4 по 0.5 = 2000 грн. + 2 по 0.5 в подарок!">Щука 4 по 0.5 = 2000 грн. + 2 по 0.5 в подарок!</option>
                                    </select>
                                    <input type="hidden" name="comm" value="Акция Щука">
                                     <input type="hidden" name="ip" value="31.128.76.48" />
                                     	<label>
					<input type="checkbox" checked="checked" required="">
					<span></span>
                ...
                <div class="item js-product">
                    ...
                    <div class="text-area">
                        <div class="item-title">ИКРА ГОРБУШИ<br></div>
                        <ul class="text-wrapper">
                            <li class="item-check-text">
                                <span class="check-img">✔</span>
                                <span class="strong">Состав:</span>
                                Икра Горбуши, соль (2-2,3% малосольная), растительное масло;
                            </li>
                            <li class="item-check-text">
                                <span class="check-img">✔</span>
                                <span class="strong">Нерест 2023 года</span>
                    ...
                    <div class="timer-wrapper">
                        ...
                        <div class="timer-button">КУПИТЬ ГОРБУШУ ПО АКЦИИ</div>
                    </div>
                    <!--END TIMER-->
                    <!--Start POPUPS-->
                    <div class="t-popup t-popup_show order-popup">
                                ...
                                <form id="form5" action="order.php" method="POST" class="t-form t-form_inputs-total_2 form-area">
                                    ...
                                    <select name="Quantity" class="quantity" style="height: 60px;background-color: transparent;border-radius: 5px;width: 91%;border: 1px solid #c9c9c9;padding: 0 20px;font-size: 16px;color: #000;">
                                        <option value="Горбуша 0.5 = 540 грн" selected="">Горбуша 0.5 = 540 грн</option>
                                          <option value="Горбуша 2 по 0.5 = 1080 грн. + 0.5 в подарок!">Горбуша 2 по 0.5 = 1080 грн. + 0.5 в подарок!</option>
                                        <option value="Горбуша 3 по 0.5 = 1620 грн. + 0.5 в подарок!">Горбуша 3 по 0.5 = 1620 грн. + 0.5 в подарок!</option>
                                        <option value="Горбуша 4 по 0.5 = 2160 грн. + 2 по 0.5 в подарок!">Горбуша 4 по 0.5 = 2160 грн. + 2 по 0.5 в подарок!</option>
                                       
                                    </select>
                                    <input type="hidden" name="comm" value="Горбуша в один клик">
                                     <input type="hidden" name="ip" value="31.128.76.48" />
                                     	<label>
					<input type="checkbox" checked="checked" required="">
					<span></span>
                        ...
                        <div class="t-popup__container t-width t-width_6 t-popup__container-static t-popup__container-animated"> <img class="t702__img t-img loaded" src="img/__27.png" data-original="img/__27.png" imgfield="img">
                            <div class="t702__wrapper">
                                ...
                                <form id="form3" action="order.php" method="POST" class="t-form t-form_inputs-total_2 form-area">
                                    ...
                                    <input type="hidden" name="comm" value="Акция Горбуша">
                                     <input type="hidden" name="ip" value="31.128.76.48" />
                                     	<label>
					<input type="checkbox" checked="checked" required="">
					<span></span>
                  ...
                  <div class="item js-product">
                    ...
                    <div class="text-area">
                        <div class="item-title">ИКРА ЧАВЫЧИ<br></div>
                        <ul class="text-wrapper">
                            <li class="item-check-text">
                                <span class="check-img">✔</span>
                                <span class="strong">Состав:</span>
                                Икра Чавычи, соль (2-2,3% малосольная), растительное масло;
                            </li>
                            <li class="item-check-text">
                                <span class="check-img">✔</span>
                                <span class="strong">Нерест 2023 года</span>
                    ...
                    <div class="timer-wrapper">
                        ...
                        <div class="timer-button">КУПИТЬ ЧАВЫЧУ ПО АКЦИИ</div>
                    </div>
                    <!--END TIMER-->
                    <!--Start POPUPS-->
                    <div class="t-popup t-popup_show order-popup">
                        ...
                        <div class="t-popup__container t-width t-width_6 t-popup__container-static t-popup__container-animated"> <img class="t702__img t-img loaded" src="img/__27.png" data-original="img/__27.png" imgfield="img">
                            <div class="t702__wrapper">
                                <div class="t702__text-wrapper t-align_center">
                                    <div class="t702__title t-title t-title_xxs" style="">КУПИТЬ ИКРУ ЧАВЫЧИ
                                        <br>
                                    </div>
                                </div>
                                <form id="form5" action="order.php" method="POST" class="t-form t-form_inputs-total_2 form-area">
                                    ...
                                    <input type="tel" name="Phone" class="t-input phone-mask" required="" placeholder="Ваш номер телефона - заполняется цифрами" style="color:#000000; border:1px solid #c9c9c9; border-radius: 5px; -moz-border-radius: 5px; -webkit-border-radius: 5px; margin-bottom: 20px;">
                                    <select name="Quantity" class="quantity" style="height: 60px;background-color: transparent;border-radius: 5px;width: 91%;border: 1px solid #c9c9c9;padding: 0 20px;font-size: 16px;color: #000;">
                                        <option value="Чавыча 0.5 = 600 грн" selected="">Чавыча 0.5 = 600 грн</option>
                                          <option value="Чавыча по 0.5 = 1200 грн. + 0.5 в подарок!">Чавыча 2 по 0.5 = 1200 грн. + 0.5 в подарок!</option>
                                        <option value="Чавыча по 0.5 = 1800 грн. + 0.5 в подарок!">Чавыча 3 по 0.5 = 1800 грн. + 0.5 в подарок!</option>
                                        <option value="Чавыча по 0.5 = 2400 грн. + 2 по 0.5 в подарок!">Чавыча 4 по 0.5 = 2400 грн. + 2 по 0.5 в подарок!</option>
                                       
                                    </select>
                                    <input type="hidden" name="comm" value="Чавыча в один клик">
                                     <input type="hidden" name="ip" value="31.128.76.48" />
                                     	<label>
					<input type="checkbox" checked="checked" required="">
					<span></span>
                        ...
                        <div class="t-popup__container t-width t-width_6 t-popup__container-static t-popup__container-animated"> <img class="t702__img t-img loaded" src="img/__27.png" data-original="img/__27.png" imgfield="img">
                            <div class="t702__wrapper">
                                ...
                                <form id="form3" action="order.php" method="POST" class="t-form t-form_inputs-total_2 form-area">
                                    ...
                                    <input type="hidden" name="comm" value="Акция Чавыча">
                                     <input type="hidden" name="ip" value="31.128.76.48" />
                                     	<label>
					<input type="checkbox" checked="checked" required="">
					<span></span>
                ...
                <div class="item js-product">
                    ...
                    <div class="text-area">
                        <div class="item-title">ИКРА ФОРЕЛИ<br></div>
                        <ul class="text-wrapper">
                            <li class="item-check-text">
                                <span class="check-img">✔</span>
                                <span class="strong">Состав:</span>
                                Икра Форели, соль (4% малосольная), растительное масло;
                            </li>
                            <li class="item-check-text">
                                <span class="check-img">✔</span>
                                <span class="strong">Нерест 2023 года</span>
                    ...
                    <div class="timer-wrapper">
                        ...
                        <div class="timer-button">КУПИТЬ ФОРЕЛЬ ПО АКЦИИ</div>
                    </div>
                    <!--END TIMER-->
                    ...
                    <div class="t-popup t-popup_show order-popup">
                        ...
                        <div class="t-popup__container t-width t-width_6 t-popup__container-static t-popup__container-animated"> <img class="t702__img t-img loaded" src="img/__27.png" data-original="img/__27.png" imgfield="img">
                            <div class="t702__wrapper">
                                <div class="t702__text-wrapper t-align_center">
                                    <div class="t702__title t-title t-title_xxs" style="">КУПИТЬ ИКРУ ФОРЕЛИ
                                        <br>
                                    </div>
                                </div>
                                <form id="form4" action="order.php" method="POST" class="t-form t-form_inputs-total_2 form-area">
                                    ...
                                    <input type="hidden" name="comm" value="Форель в один клик">
                                     <input type="hidden" name="ip" value="31.128.76.48" />
                                     	<label>
					<input type="checkbox" checked="checked" required="">
					<span></span>
                 ...
                 <div class="item js-product">
                    ...
                    <div class="text-area">
                        <div class="item-title">ИКРА ВЕСЛОНОСА<br></div>
                        <ul class="text-wrapper">
                            <li class="item-check-text">
                                <span class="check-img">✔</span>
                                <span class="strong">Состав:</span>
                                 Икра Веслоноса, соль, растительное масло;
                            </li>
                            <li class="item-check-text">
                                <span class="check-img">✔</span>
                                <span class="strong">Нерест 2023 года</span>
                    ...
                    <div class="timer-wrapper">
                        ...
                        <div class="timer-button">КУПИТЬ ВЕСЛОНОС ПО АКЦИИ</div>
                    </div>
                    <!--END TIMER-->
                            ...
                            <div class="t702__wrapper">
                                ...
                                <form id="form7" action="order.php" method="POST" class="t-form t-form_inputs-total_2 form-area">
                                    ...
                                    <select name="Quantity" class="quantity" style="height: 60px;background-color: transparent;border-radius: 5px;width: 91%;border: 1px solid #c9c9c9;padding: 0 20px;font-size: 16px;color: #000;">
                                        ...
                                        <option value="Веслонос 2 по 0.250 = 1080 грн. + 0.250 в подарок!">Веслонос 2 по 0.250 = 1080 грн. + 0.250 в подарок!</option>
                                        <option value="Веслонос 3 по 0.250 = 1620 грн. + 0.250 в подарок!">Веслонос 3 по 0.250 = 1620 грн. + 0.250 в подарок!</option>
                                        <option value="Веслонос 4 по 0.250 = 2160 грн. + 2 по 0.250 в подарок!">Веслонос 4 по 0.250 = 2160 грн. + 2 по 0.250 в подарок!</option>
                                       
                                    </select>
                                    <input type="hidden" name="comm" value="Веслонос в один клик 250">
                                     <input type="hidden" name="ip" value="31.128.76.48" />
                                     	<label>
					<input type="checkbox" checked="checked" required="">
					<span></span>
                        ...
                        <div class="t-popup__container t-width t-width_6 t-popup__container-static t-popup__container-animated"> <img class="t702__img t-img loaded" src="img/__27.png" data-original="img/__27.png" imgfield="img">
                            <div class="t702__wrapper">
                                ...
                                <form id="form3" action="order.php" method="POST" class="t-form t-form_inputs-total_2 form-area">
                                    ...
                                    <input type="hidden" name="comm" value="Акция Веслонос 250">
                                     <input type="hidden" name="ip" value="31.128.76.48" />
                                     	<label>
					<input type="checkbox" checked="checked" required="">
					<span></span>
                            ...
                            <div class="t702__wrapper">
                                ...
                                <form id="form6" action="order.php" method="POST" class="t-form t-form_inputs-total_2 form-area">
                                    ...
                                    <select name="Quantity" class="quantity" style="height: 60px;background-color: transparent;border-radius: 5px;width: 91%;border: 1px solid #c9c9c9;padding: 0 20px;font-size: 16px;color: #000;">
                                        ...
                                        <option value="Веслонос по 0.5 = 1800 грн. + 0.5 в подарок!">Веслонос 2 по 0.5 = 1800 грн. + 0.5 в подарок!</option>
                                        <option value="Веслонос по 0.5 = 2700 + 0.5 в подарок!">Веслонос 3 по 0.5 = 2700 грн. + 0.5 в подарок!</option>
                                        <option value="Веслонос по 0.5 = 3600 грн. + 2 по 0.5 в подарок!">Веслонос 4 по 0.5 = 3600 грн. + 2 по 0.5 в подарок!</option>
                                        
                                       
                                    </select>
                                    <input type="hidden" name="comm" value="Веслонос в один клик">
                                     <input type="hidden" name="ip" value="31.128.76.48" />
                                     	<label>
					<input type="checkbox" checked="checked" required="">
					<span></span>
                            ...
                            <div class="t702__wrapper">
                                ...
                                <form id="form3" action="order.php" method="POST" class="t-form t-form_inputs-total_2 form-area">
                                    ...
                                    <select name="Quantity" class="quantity" style="height: 60px;background-color: transparent;border-radius: 5px;width: 91%;border: 1px solid #c9c9c9;padding: 0 20px;font-size: 16px;color: #000">
	                                    ...
	                                    <input type="hidden" name="comm" value="Акция Веслонос">
                                     <input type="hidden" name="ip" value="31.128.76.48" />
                                     	<label>
					<input type="checkbox" checked="checked" required="">
					<span></span>
                ...
                <div class="item js-product">
                    ...
                    <div class="text-area">
                        <div class="item-title">ИКРА ОСЕТРА<br></div>
                        <ul class="text-wrapper">
                            <li class="item-check-text">
                                <span class="check-img">✔</span>
                                <span class="strong">Состав:</span>
                                Икра Оcетра, соль, растительное масло;
                            </li>
                            <li class="item-check-text">
                                <span class="check-img">✔</span>
                                <span class="strong">Нерест 2023 года</span>
                    ...
                    <div class="timer-wrapper">
                        ...
                        <div class="timer-button">КУПИТЬ ОСЕТР ПО АКЦИИ</div>
                    </div>
                    <!--END TIMER-->
                    <!--Start POPUPS-->
                    <div class="t-popup t-popup_show order-popup">
                            ...
                            <div class="t702__wrapper">
                                ...
                                <form id="form7" action="order.php" method="POST" class="t-form t-form_inputs-total_2 form-area">
                                    ...
                                    <select name="Quantity" class="quantity" style="height: 60px;background-color: transparent;border-radius: 5px;width: 91%;border: 1px solid #c9c9c9;padding: 0 20px;font-size: 16px;color: #000;">
                                        ...
                                        <option value="Осетр 2 по 0.100 = 1850 грн. + 0.100 в подарок!">Осетр 2 по 0.100 = 1850 грн. + 0.100 в подарок!</option>
                                        <option value="Осетр 3 по 0.100 = 2775 грн. + 0.100 в подарок!">Осетр 3 по 0.100 = 2775 грн. + 0.100 в подарок!</option>
                                        <option value="Осетр 4 по 0.100 = 3700 грн. + 2 по 0.100 в подарок!">Осетр 4 по 0.100 = 3700 грн. + 2 по 0.100 в подарок!</option>
                                        
                                    </select>
                                    <input type="hidden" name="comm" value="Осетр в один клик 100">
                                     <input type="hidden" name="ip" value="31.128.76.48" />
                                     	<label>
					<input type="checkbox" checked="checked" required="">
					<span></span>
                        ...
                        <div class="t-popup__container t-width t-width_6 t-popup__container-static t-popup__container-animated"> <img class="t702__img t-img loaded" src="img/__27.png" data-original="img/__27.png" imgfield="img">
                            <div class="t702__wrapper">
                                ...
                                <form id="form3" action="order.php" method="POST" class="t-form t-form_inputs-total_2 form-area">
                                    ...
                                    <input type="hidden" name="comm" value="Акция Осетра 100">
                                     <input type="hidden" name="ip" value="31.128.76.48" />
                                     	<label>
					<input type="checkbox" checked="checked" required="">
					<span></span>
                            ...
                            <div class="t702__wrapper">
                                ...
                                <form id="form7" action="order.php" method="POST" class="t-form t-form_inputs-total_2 form-area">
                                    ...
                                    <select name="Quantity" class="quantity" style="height: 60px;background-color: transparent;border-radius: 5px;width: 91%;border: 1px solid #c9c9c9;padding: 0 20px;font-size: 16px;color: #000;">
                                        ...
                                        <option value="Осетр 2 по 0.250 = 4400 грн. + 0.100 в подарок!">Осетр 2 по 0.250 = 4400 грн. + 0.100 в подарок!</option>
                                        <option value="Осетр 3 по 0.250 = 6600 грн. + 0.100 в подарок!">Осетр 3 по 0.250 = 6600 грн. + 0.100 в подарок!</option>
                                        <option value="Осетр 4 по 0.250 = 8800 грн. + 2 по 0.250 в подарок!">Осетр 4 по 0.250 = 8800 грн. + 2 по 0.250 в подарок!</option>
                                      
                                    </select>
                                    <input type="hidden" name="comm" value="Осетр в один клик">
                                     <input type="hidden" name="ip" value="31.128.76.48" />
                                     	<label>
					<input type="checkbox" checked="checked" required="">
					<span></span>
                        ...
                        <div class="t-popup__container t-width t-width_6 t-popup__container-static t-popup__container-animated"> <img class="t702__img t-img loaded" src="img/__27.png" data-original="img/__27.png" imgfield="img">
                            <div class="t702__wrapper">
                                ...
                                <form id="form3" action="order.php" method="POST" class="t-form t-form_inputs-total_2 form-area">
                                    ...
                                    <input type="hidden" name="comm" value="Акция Осетр">
                                     <input type="hidden" name="ip" value="31.128.76.48" />
                                     	<label>
					<input type="checkbox" checked="checked" required="">
					<span></span>
            ...
            <div class="t-cover" id="recorddiv158821723" bgimgfield="img" style="height:100vh; background-image:url('img/Seafoods_Butterbrot_.jpg');">
                ...
                <div class="t698">
                            ...
                            <div class="t-cover__wrapper t-valign_middle" style="height:100vh;">
                                <div class="t698__mainwrapper" data-hook-content="covercontent">
                                    <div class="t698__title t-title t-title_xs" style="" field="title">
                                        <div style="color:#ffffff;" data-customstyle="yes">Акционное предложение 1 + 1 = 3</div>
                                    </div>
                                    <div class="t698__descr t-descr t-descr_md" style="" field="descr">
                                        <div style="font-size:24px;" data-customstyle="yes">При покупке 2-х баночек 500г икры,
                                            <br> баночка 500г в подарок!</div>
                                    </div>
                                    <div>
                                        <form id="form1" action='order.php' method='POST' class="t-form t-form_inputs-total_2 form-area">
                                            <input type="tel" name="Phone" class="t-input phone-mask" required placeholder="Ваш номер телефона - заполняется цифрами" style="color:#000000; background-color:#ffffff; border-radius: 7px; -moz-border-radius: 7px; -webkit-border-radius: 7px; margin-bottom: 20px;">
                                            <input type="text" name="Name" class="t-input name-mask" required placeholder="Имя - кириллица" style="background-color:#ffffff; color:#000000; border:1px solid #c9c9c9; border-radius: 5px; -moz-border-radius: 5px; -webkit-border-radius: 5px; margin-bottom: 20px;">
                                            <input type="text" name="lastName" class="t-input last-name-mask" required placeholder="Фамилия - кириллица" style="background-color:#ffffff; color:#000000; border:1px solid #c9c9c9; border-radius: 5px; -moz-border-radius: 5px; -webkit-border-radius: 5px; margin-bottom: 20px;">
                                            <input type="text" name="City" class="t-input city-mask" required placeholder="Город доставки - кириллица" style="color:#000000; border:1px solid #c9c9c9; border-radius: 5px; background: #ffffff;-moz-border-radius: 5px; -webkit-border-radius: 5px; margin-bottom: 20px;">
                                            <input type="text" name="Department" class="t-input department-mask" required placeholder="Номер отделение НП - заполняется цифрами" style="color:#000000; border:1px solid #c9c9c9; border-radius: 5px; background: #ffffff;-moz-border-radius: 5px; -webkit-border-radius: 5px; margin-bottom: 20px;">
                                      ...
                                      <option value="Форель 2 по 0.5 = 1220 грн. + 0.5 в подарок!">Форель: 2 по 0.5 = 1220 грн. + 0.5 в подарок!</option>
                                       <option value="Чавыча 2 по 0.5 = 1200 грн. + 0.5 в подарок!">Чавыча: 2 по 0.5 = 1200 грн. + 0.5 в подарок!</option>
                                        <option value="Осетр 2 по 0.5 = 1850 грн. + 0.5 в подарок!">Осетр: 2 по 0.5 = 1850 грн. + 0.5 в подарок!</option>
                                            ...
                                            <input type="hidden" name="comm" value="Акция 1+1=3с">
                                            <input type="hidden" name="ip" value="31.128.76.48" />
                                            	<label>
					<input type="checkbox" checked="checked" required="">
					<span></span>
					Я згоден з політикою конфіденційності та користувальницькою угодою
                                    ...
                                    <div class="t698__form-bottom-text t-text t-text_xs" field="text">Спешите! Предложение Ограничено!</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="t472">
                <div class="t-container t-align_center">
                    <div class="t-col t-col_8 t-prefix_2">
                        <div class="t472__title t-section__title t-title t-title_md t-margin_auto text" field="title" style="">О НАС
                            <br>
                        </div>
                        <div class="t472__descr t-section__descr t-descr t-descr_xxl t-margin_auto text" field="descr" style="">
                            <div style="font-size:18px;" data-customstyle="yes">Мы занимаемся поставкой и добываем ИКРУ для украинцев уже 5-й год. За это время мы сформировали клиентскую базу, которая насчитывает около 1200 клиентов. К тому же, каждую неделю мы поставляем ИКРУ в лучшие кафе и рестораны Украины. Количество поставок к местам общественного питания насчитывает около 40 различных заведений! Покупая ИКРУ в нашем магазине, Вы делаете выбор правильным, поскольку наша Цена без накруток за помещение и без заработной платы работникам. Наш маленький склад полностью оборудован по всем санитарно-гигиеническим требованиям. Можете быть уверены в качестве нашего продукта, мы ценим свое имя и ценим каждого клиента.</div>
                        </div>
                    </div>
                ...
                <div class="t-container t-align_center">
                    <div class="t-col t-col_10 t-prefix_1">
                        <div class="t017__title t-title t-title_xxs text" field="title" style="">
                            <div style="font-size:52px;" data-customstyle="yes">ВОПРОСЫ, КОТОРЫЕ ЗАДАЮТ ЧАЩЕ ВСЕГО</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="t-container">
                        ...
                        <div class="t668__accordion">
                            <div class="t668__wrapper" style="background-color: #2b2b2b;">
                                <div class="t668__header" style="">
                                    <div class="t668__title t-name t-name_xl" field="li_title__1480611044356" style="color:#ffffff;">СРОКИ ДОСТАВКИ?</div>
                                ...
                                <div class="t668__content" style="">
                                    <div class="t668__textwrapper">
                                        <div class="t668__text t-descr t-descr_xs" field="li_descr__1480611044356" style="color:#ffffff;">Чаще всего доставка Новой почтой занимает 1 день. Иногда в случаях доставки до поселков доставка может занимать от 1 до 2-х дней..</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="t668__col t-col t-col_8 t-prefix_2" style="margin-bottom:2px;">
                        <div class="t668__accordion">
                            <div class="t668__wrapper" style="background-color: #2b2b2b;">
                                <div class="t668__header" style="">
                                    <div class="t668__title t-name t-name_xl" field="li_title__1480611048442" style="color:#ffffff;">КАКИЕ СПОСОБЫ ОПЛАТЫ?</div>
                                    <div class="t668__icon">
                                        <div class="t668__lines">
                                            <svg width="24px" height="24px" viewBox="0 0 24 24" xmlns="https://www.w3.org/2000/svg" xmlns:xlink="https://www.w3.org/1999/xlink">
                                                <g stroke="none" stroke-width="1px" fill="none" fill-rule="evenodd" stroke-linecap="square">
                                ...
                                <div class="t668__content" style="">
                                    <div class="t668__textwrapper">
                                        <div class="t668__text t-descr t-descr_xs" field="li_descr__1480611048442" style="color:#ffffff;">Мы работаем с наложенным платежом Новая Почта.
                                            <br>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="t668__col t-col t-col_8 t-prefix_2" style="margin-bottom:2px;">
                        <div class="t668__accordion">
                            <div class="t668__wrapper" style="background-color: #2b2b2b;">
                                <div class="t668__header" style="">
                                    <div class="t668__title t-name t-name_xl" field="li_title__1580470876827" style="color:#ffffff;">ПОЧЕМУ У ВАС ТАКАЯ НИЗКАЯ ЦЕНА?</div>
                                    <div class="t668__icon">
                                        <div class="t668__lines">
                                            <svg width="24px" height="24px" viewBox="0 0 24 24" xmlns="https://www.w3.org/2000/svg" xmlns:xlink="https://www.w3.org/1999/xlink">
                                                <g stroke="none" stroke-width="1px" fill="none" fill-rule="evenodd" stroke-linecap="square">
                                ...
                                <div class="t668__content" style="">
                                    <div class="t668__textwrapper">
                                        <div class="t668__text t-descr t-descr_xs" field="li_descr__1580470876827" style="color: #ffffff;">У нас нет затрат, связанных с дорогой арендой помещений и большого количества персонала. Также, целенаправленно занимаясь одним продуктом, мы имеем хорошие условия у поставщиков. Именно это позволяет нам сформировать низкую цену для покупателей..</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="t668__col t-col t-col_8 t-prefix_2" style="margin-bottom:2px;">
                        <div class="t668__accordion">
                            <div class="t668__wrapper" style="background-color: #2b2b2b;">
                                <div class="t668__header" style="">
                                    <div class="t668__title t-name t-name_xl" field="li_title__1580470878519" style="color: #ffffff;">ЕСТЬ КАКИЕ-ТО ПОДОЗРЕНИЯ ПО ПОВОДУ КАЧЕСТВА ИКРЫ?</div>
                                    <div class="t668__icon">
                                        <div class="t668__lines">
                                            <svg width="24px" height="24px" viewBox="0 0 24 24" xmlns="https://www.w3.org/2000/svg" xmlns:xlink="https://www.w3.org/1999/xlink">
                                                <g stroke="none" stroke-width="1px" fill="none" fill-rule="evenodd" stroke-linecap="square">
                                ...
                                <div class="t668__content" style="">
                                    <div class="t668__textwrapper">
                                        <div class="t668__text t-descr t-descr_xs" field="li_descr__1580470878519" style="color: #ffffff;">Мы не берем с Вас предоплаты. Вы можете осмотреть товар на Новой Почте и убедиться в качестве нашей продукции. Если у Вас возникнут сомнения, Вы имеете право не забирать посылку. Все денежные расходы ложатся на отправителя. Почему вы ничем не рискуете. Мы делаем так, потому что уверены в своем продукте.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="t668__col t-col t-col_8 t-prefix_2" style="margin-bottom:2px;">
                        <div class="t668__accordion">
                            <div class="t668__wrapper" style="background-color: #2b2b2b;">
                                <div class="t668__header" style="">
                                    <div class="t668__title t-name t-name_xl" field="li_title__1489600117321" style="color: #ffffff;">СВЯЖАЯ ЛИ ИКРА? </div>
                                    <div class="t668__icon">
                                        <div class="t668__lines">
                                            <svg width="24px" height="24px" viewBox="0 0 24 24" xmlns="https://www.w3.org/2000/svg" xmlns:xlink="https://www.w3.org/1999/xlink">
                                                <g stroke="none" stroke-width="1px" fill="none" fill-rule="evenodd" stroke-linecap="square">
                                ...
                                <div class="t668__content" style="">
                                    <div class="t668__textwrapper">
                                        <div class="t668__text t-descr t-descr_xs" field="li_descr__1489600117321" style="color: #ffffff;">Поставки идут напрямую от производителя. Средний срок поставки икры от производителя к нам Составляет около 7 дней. Именно свежесть продукта и является нашим основным преимуществом!</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="t-col t-col_12">
                        <div class="t-section__topwrapper t-align_center">
                            <div class="t-section__title t-title t-title_xs text" field="btitle">
                                <div style="font-size:52px;" data-customstyle="yes">ОТЗЫВЫ</div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="t533__col t-col t-col_4 t-align_left">
                            <div class="t533__content">
                                <div class="t533__textwrapper t-align_center" style=" border: 0px solid #000;background-color: #2b2b2b; ">
                                    ...
                                    <div class="t533__descr t-text t-text_xs" style="color: #ffffff;" field="li_descr__1580463102911">очень профессиональный менеджер, максимально дал консультацию по всем видам икры ,купила кету, очень вкусная, гости на свадьбе были очень довольны.</div>
                                </div>
                                <div class="t533__imgwrapper">
                        ...
                        <div class="t533__col t-col t-col_4 t-align_left">
                            <div class="t533__content">
                                <div class="t533__textwrapper t-align_center" style=" border: 0px solid #000;background-color: #2b2b2b; ">
                                    ...
                                    <div class="t533__descr t-text t-text_xs" style="color: #ffffff;" field="li_descr__1580463106214"> Заказал ИКРУ Горбушы на сайте, перезвонили в течении 15 минут, заказал ИКРУ горбушы , качество супер мне очень понравилось, буду покупать ещё.
                                        <br> </div>
                                </div>
                                <div class="t533__imgwrapper">
                        ...
                        <div class="t533__col t-col t-col_4 t-align_left">
                            <div class="t533__content">
                                <div class="t533__textwrapper t-align_center" style=" border: 0px solid #000;background-color: #2b2b2b; ">
                                    ...
                                    <div class="t533__descr t-text t-text_xs" style="color: #ffffff;" field="li_descr__1580463082896">а звичайно норм! Я в їх вже декілька разів замовляв. А замовляв тут місяць тому - то таких знижок тоді не було.Так шо всім раджу.</div>
                                </div>
                                <div class="t533__imgwrapper">
            ...
            <div class="t859">
                <div class="t-section__container t-container">
                    <div class="t-col t-col_12">
                        <div class="t-section__topwrapper t-align_center">
                            <div class="t-section__title t-title t-title_xs text" field="btitle">
                                <div style="font-size:52px;" data-customstyle="yes">ОПЛАТА И ДОСТАВКА
                                    <br>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="t859__inner-col" style="background-color: #2b2b2b; border-radius:5px; box-shadow: 0px 0px 10px 0px rgba(0, 0, 0, 0.10);">
                                <div class="t859__wrap">
                                    ...
                                    <div class="t859__wrap_right">
                                        <div class="t-name t-name_lg t859__bottommargin" style="color: #ffffff;" field="li_title__1533113804891">ОПЛАТА ПРИ ПОЛУЧЕНИИ
                                            <br>
                                        </div>
                                        <div class="t-descr t-descr_sm" style="color: #ffffff;" field="li_descr__1533113804891">Вы можете просмотреть товар и убедиться в качестве при получении. Товар отправляется наложенным платежом.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="t859__col t-col t-col_6 ">
                            <div class="t859__inner-col" style="background-color:#2b2b2b; border-radius:5px; box-shadow: 0px 0px 10px 0px rgba(0, 0, 0, 0.10);">
                                <div class="t859__wrap">
                                    ...
                                    <div class="t859__wrap_right">
                                        <div class="t-name t-name_lg t859__bottommargin" style="color: #ffffff;" field="li_title__1533113964390">БЫСТРАЯ ДОСТАВКА ПО УКРАИНЕ
                                            <br>
                                        </div>
                                        <div class="t-descr t-descr_sm" style="color: #ffffff;" field="li_descr__1533113964390">Отправляем <strong>Новой  Почтой</strong>по Украине согласно тарифам компании.
                                            <br>Срок доставки 1-2 дня.
                                            <br>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="t-container ">
                        <div class="t-width t-width_8 t698__mainblock">
                            <div class="t-cover__wrapper t-valign_middle" style="height:100vh;">
                                <div class="t698__mainwrapper" data-hook-content="covercontent">
                                    <div class="t698__title t-title t-title_xs" style="" field="title">
                                        <div style="color:#ff1e00;" data-customstyle="yes">Акционное предложение 1 + 1 = 3</div>
                                    </div>
                                    <div class="t698__descr t-descr t-descr_md" style="" field="descr">
                                        <div style="font-size:24px;" data-customstyle="yes"> При покупке 2-х баночек 500г икры,
                                            баночка 500г в подарок!</div>
                                    </div>
                                    <div>
                                      ...
                                      <option value="Форель 2 по 0.5 = 1220 грн. + 0.5 в подарок!">Форель: 2 по 0.5 = 1220 грн. + 0.5 в подарок!</option>
                                       <option value="Чавыча 2 по 0.5 = 1200 грн. + 0.5 в подарок!">Чавыча: 2 по 0.5 = 1200 грн. + 0.5 в подарок!</option>
                                        <option value="Осетр 2 по 0.5 = 1850 грн. + 0.5 в подарок!">Осетр: 2 по 0.5 = 1850 грн. + 0.5 в подарок!</option>
                                            ...
                                            <input type="hidden" name="comm" value="Акция 1+1=3н">
                                            <input type="hidden" name="ip" value="31.128.76.48" />
                                            	<label>
					<input type="checkbox" checked="checked" required="">
					<span></span>
...
<footer class="footer_section night-theme-background active-color" style="padding: 0 20px 50px">
    <div class="wrapper">
        <div style="margin: 0 auto; text-align: center;">
            <a style="color: #ff1e00; text-decoration: none;"  href="politics.html" target="_blank">Политика конфиденциальности</a>
        </div>
        <div style="margin: 5px auto; text-align: center;">
            <a style="color: #ff1e00; text-decoration: none;" target="_blank" href="oferta.html">Договор оферты</a>
        </div>
    </div>
...
<script>
  ...
  {if(f.fbq)return;n=f.fbq=function(){n.callMethod?
    ...
    s.parentNode.insertBefore(t,s)}(window, document,'script',
    'https://connect.facebook.net/en_US/fbevents.js');
  fbq('init', '863028985313252');
  fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
               src="https://www.facebook.com/tr?id=863028985313252&ev=PageView&noscript=1"
    /></noscript>
<!-- End Meta Pixel Code -->
</body>
